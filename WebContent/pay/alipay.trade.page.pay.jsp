...
//获得初始化的AlipayClient
	...
	//付款金额，必填
	String total_amount = new String(request.getParameter("allprice").getBytes("ISO-8859-1"),"UTF-8");
	//订单名称，必填
	String subject = new String(request.getParameter("orderName").getBytes("ISO-8859-1"),"UTF-8");
	//商品描述，可空
	String body = new String(request.getParameter("shopDesc").getBytes("ISO-8859-1"),"UTF-8");
